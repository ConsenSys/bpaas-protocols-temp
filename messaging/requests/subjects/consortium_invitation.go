...
const (
	CONSORTIUM_INVITATION_APPROVAL_ACCEPT = "bpaas.consortium_invitation.approval.accept"
	CONSORTIUM_INVITATION_APPROVAL_REJECT = "bpaas.consortium_invitation.approval.reject"
