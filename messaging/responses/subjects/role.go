...
const (
	...
	ROLES_LIST_COMPANY_ROLES_COMPLETED             = "bpaas.roles.list_company_roles.completed"
	ROLES_LIST_COMPANY_ROLES_FAILED                = "bpaas.roles.list_company_roles.failed"
	ROLES_LIST_PLATFORM_ROLES_COMPLETED            = "bpaas.roles.list_platform_roles.completed"
	ROLES_LIST_PLATFORM_ROLES_FAILED               = "bpaas.roles.list_platform_roles.failed"
)
